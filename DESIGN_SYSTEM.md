# Seatly - Especificação de UI/UX para Plataforma Completa

## 1. Visão Geral do Produto

O **Seatly** evoluiu para uma plataforma *End-to-End* (Ponta a Ponta) que atende a três perfis distintos de usuários:
...
3. **Compartilhamento:** Um botão "Compartilhar Ingresso".
    *   *Web:* Copia um link único (ex: `seatly.com/ticket/A1B2C3D4`) para a área de transferência. Ao abrir esse link, a pessoa vê o ingresso digital.
...
*   **Webcam na Portaria:** Certifique-se de pedir a permissão da câmera (Browser Permissions) de forma amigável: *"O Seatly Validador precisa acessar sua câmera para ler os QRs"*.
