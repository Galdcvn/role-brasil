...
export default function Input({ icon, showToggle, type, className = '', ...props }: InputProps) {
    ...
    <div className="relative">
      ...
      {isPassword && (
        <button
          ...
          className="absolute right-3 top-3.5 h-5 w-5 text-slate-400 hover:text-slate-200 transition-colors"
